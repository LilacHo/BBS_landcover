# Using NLCD to count categorical landcover pixels
# within 30-km buffer around a single point
...
input_file_path <- input_nlcd_path(product, year, version) #eg: ("LndCov", 2023, 0)
